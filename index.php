...
<div class="sn1">
   ...
   <ul class="sn">
         ...
         <a href="lndex.php?logout"><img src="images/login.png"></a>
...
<div id="container">
	...
	<div id="circle_box">
		...
		<div id="pie3" onclick="onclick_pie3()">
			<div id="pie3_content">
				<h1>UPLOAD</h1>
			</div>
		</div>
	...
	<div id="overlay_upload" class="overlay">
		...
		<div id="alert" class="overlay_content">
		 <div align="center"> 
			<iframe class="rounded_border" src="contact/login.php" style=" width:800px; align:middle; height:100px; border:none;" scrolling="auto"></iframe>
	...
	<div id="overlay_jc" class="overlay">
		...
		<div id="judging_criteria" class="overlay_content">
			<img src="images/judge.jpg" onclick="close_overlay()" height="auto" width="auto" border="none" align="centre" scrolling="no" class="rounded_border">
		</div>
	</div>
